...
```bash
my-sam-tutorial-app$ sam build --use-container
```
...
```bash
my-sam-tutorial-app$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
my-sam-tutorial-app$ sam local start-api
my-sam-tutorial-app$ curl http://localhost:3000/
```
